...
public class DeleteMenuLayout extends ViewGroup
{
    ...
    private static DeleteMenuLayout mViewCache;
    ...
    public DeleteMenuLayout(Context context) {
        this(context, (AttributeSet)null);
    }

    public DeleteMenuLayout(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public DeleteMenuLayout(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    public DeleteMenuLayout setIos(boolean ios) {
        this.isIos = ios;
        return this;
    }
    ...
    public DeleteMenuLayout setLeftSwipe(boolean leftSwipe) {
        this.isLeftSwipe = leftSwipe;
        return this;
    }

    public static DeleteMenuLayout getViewCache() {
        return mViewCache;
    }
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        @SuppressLint("WrongConstant") boolean measureMatchParentChildren = MeasureSpec.getMode(heightMeasureSpec) != 1073741824;
    ...
    private void forceUniformHeight(int count, int widthMeasureSpec) {
        @SuppressLint("WrongConstant") int uniformMeasureSpec = MeasureSpec.makeMeasureSpec(this.getMeasuredHeight(), 1073741824);
    ...
    public void smoothExpand() {
        ...
        this.mExpandAnim.addUpdateListener(new AnimatorUpdateListener() {
            public void onAnimationUpdate(ValueAnimator animation) {
                DeleteMenuLayout.this.scrollTo((Integer)animation.getAnimatedValue(), 0);
            }
        });
        ...
        this.mExpandAnim.addListener(new AnimatorListenerAdapter() {
            public void onAnimationEnd(Animator animation) {
                DeleteMenuLayout.this.isExpand = true;
            }
        });
    ...
    public void smoothClose() {
        ...
        this.mCloseAnim.addListener(new AnimatorListenerAdapter() {
            public void onAnimationEnd(Animator animation) {
                DeleteMenuLayout.this.isExpand = false;
            }
        });
