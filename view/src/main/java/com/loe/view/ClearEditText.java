        ...
        TextWatcher
{
    ...
    private void init()
    {
        ...
        {
            //          throw new NullPointerException("You can add drawableRight attribute in
            // XML");
            mClearDrawable = getResources().getDrawable(R.mipmap.clear_gray);
        }

        int size = (int) (getTextSize() * 2.7);
