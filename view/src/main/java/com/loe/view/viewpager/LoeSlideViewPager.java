...
public class LoeSlideViewPager extends ViewPager implements OnClickListener
{
    ...
    public void init(FragmentManager fragmentManager, final View line, ViewPagerItem... items)
    {
        init(fragmentManager, line, 1, items);
    }

    public void init(FragmentManager fragmentManager, final View line, final double rate, ViewPagerItem... items)
    {
